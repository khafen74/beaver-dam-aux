...
os.chdir(r'F:\01_etal\Projects\Modeling\BeaverWaterStorage\wrk_Data\AnalysisRuns\BridgeCreek\10m\2011')
modelname1 = 'cc_base'
modelname2 = 'cc_mid'
...
lpf2 = flopy.modflow.ModflowLpf(mf2, hk=ksatData, vka=kvData)
...
if success1 and success2:
    ...
    hdch_ds1 = gdal.GetDriverByName('GTiff').Create('05_MODFLOW/hdch_mid.tif', demDs.RasterXSize, demDs.RasterYSize, 1, gdal.GDT_Float32)
