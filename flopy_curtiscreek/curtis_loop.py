...
for i in range(1, 41):
    ...
    # ksatDs = gdal.Open(dirIn + '/ksat_md.tif')
    ...
    if success1 and success2:
        ...
        hdch_ds1 = gdal.GetDriverByName('GTiff').Create(dirOut + '/hdch_'+str(int(ksatData*100))+'.tif', demDs1.RasterXSize, demDs1.RasterYSize, 1,
                                                        gdal.GDT_Float32)
